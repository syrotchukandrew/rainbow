...
class LoadCategoryData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $category->setParent($this->getReference("houses", \App\Entity\Category::class));
        ...
        $category->setParent($this->getReference("flats", \App\Entity\Category::class));
        ...
        $category->setParent($this->getReference("steads", \App\Entity\Category::class));
        ...
        $category->setParent($this->getReference("commerce", \App\Entity\Category::class));
        ...
        $category->setParent($this->getReference("rent", \App\Entity\Category::class));
