...
class LoadUserData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        for ($i = 0; $i < 3; $i++) {
            ...
            $encodedPassword = $this->passwordEncoder->encodePassword($user_user, 'qweasz');
            ...
            $encodedPassword = $this->passwordEncoder->encodePassword($user_manager, 'qweasz');
        ...
        $encodedPassword = $this->passwordEncoder->encodePassword($user_admin, 'qweasz');
