...
class LoadCategoryData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $category->setParent($this->getReference("flats", \AppBundle\Entity\Category::class));
        ...
        $category->setParent($this->getReference("steads", \AppBundle\Entity\Category::class));
        ...
        $category->setParent($this->getReference("commerce", \AppBundle\Entity\Category::class));
        ...
        $category->setParent($this->getReference("rent", \AppBundle\Entity\Category::class));
