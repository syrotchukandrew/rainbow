...
(function (h, g, c, j, e, l, k) {/*! Jssor */
    ...
    var b = new function () {
        ...
        d.zd = Z;
        d.Bb = function (a) {
            if (d.af(a))a = g.getElementById(a);
            return a
        };
        function t(a) {
            return a || h.event
        ...
        if (!K())M = B(M, {A: ["scaleX", 2], D: ["scaleY", 2], db: ["translateZ", 1]});
        function N(d, a) {
            var c = "";
            if (a) {
                if (q() && i && i < 10) {
                ...
                if (K()) {
                    if (a.nb || a.pb || a.db)c += " translate3d(" + (a.nb || 0) + "px," + (a.pb || 0) + "px," + (a.db || 0) + "px)";
                    if (a.A == k)a.A = 1;
                    if (a.D == k)a.D = 1;
                    if (a.A != 1 || a.D != 1)c += " scale3d(" + a.A + ", " + a.D + ", 1)"
                }
            }
            d.style[L(d)] = c
        }
        ...
        d.Ye = function (a, b) {
            if (q() && s < 9 || s < 10 && R())a.style.zoom = b == 1 ? "" : b; else {
        ...
        d.de = function (d, a) {
            if (a)d.style.clip = "rect(" + c.round(a.e) + "px " + c.round(a.u) + "px " + c.round(a.v) + "px " + c.round(a.f) + "px)"; else {
        ...
        d.L = m("zIndex", 1);
        d.Jb = function (b, a, c) {
            if (a != k)Gb(b, a, c); else return Eb(b)
        };
        d.Wb = function (a, b) {
        ...
        function w(g, l) {
            ...
            w = function (f, c) {
                ...
                if (c.Pd)if (e)sb(d.S(j, N, f, c)); else a(f, c)
            };
            d.wb = N;
            if (e)d.wb = w;
            if (f)d.wb = a; else if (!b)a = N;
            d.K = w;
            w(g, l)
        }
        ...
        d.Mc = function (a) {
            var c = a || {};
            if (a)if (b.id(a))c = {ic: c}; else if (b.id(a.c))c.c = {ic: a.c};
            return c
        };
        d.Ad = function (l, m, w, n, y, z, o) {
            ...
            if (a.c && b.Ld() && !a.c.e && !a.c.f && a.c.u == o.kb && a.c.v == o.mb)a.c = j;
            return a
        }
    };
    ...
    var p = new function () {
        ...
        h.ce = function (d) {
            for (var e = [], a, b = 0; b < d.C; b++)for (a = 0; a < d.n; a++)g(e, c.ceil(1e5 * c.random()) % 13, [b, a]);
            return e
        }
        ...
        function i(g, d) {
            ...
            a.kf = function (c, b) {
                ...
                if (!a.ac[f]) {
                    a.ac[f] = {ib: c, bb: b};
                    for (var d = 0; d < a.n; d++)for (var e = 0; e < a.C; e++)a.ac[f][e + "," + d] = {
                        e: e * b,
                        u: d * c + c,
                        v: e * b + b,
                        f: d * c
        ...
        function o(B, h, a, w, o, m) {
            ...
            z.Yb = function (d) {
                ...
                if (e || y) {
                    ...
                    b.j(i, function (a, e) {
                        ...
                        if (a.Lc != d) {
                            if (!a.Lc && !k)b.H(n[e]); else d == a.ef && k && b.T(n[e]);
                            a.Lc = d;
                            b.K(n[e], a[d])
                        }
                    })
            ...
            b.j(p, function (h, j) {
                b.j(h, function (G) {
                    ...
                    if (a.I || a.U) {
                        var H = e;
                        if (b.tb())if (a.n * a.C > 1)H = l; else I = l;
                        if (H) {
                            d.I = a.I ? a.I - 1 : 1;
                            f.I = 1;
                            if (b.tb() || b.qd())d.I = c.min(d.I, 2);
                            var N = a.U || 0;
                            d.U = N * 360 * (x ? -1 : 1);
                            f.U = 0
                        }
                    ...
                    if (I) {
                        ...
                        if (a.c) {
                            ...
                            if (E && B) {
                                h.e = g.bb / 2 * w;
                                h.v = -h.e
                            } else if (E)h.v = -g.bb * w; else if (B)h.e = g.bb * w;
                            if (D && C) {
                                h.f = g.ib / 2 * w;
                                h.u = -h.f
                            } else if (D)h.u = -g.ib * w; else if (C)h.f = g.ib * w
                        }
                        s.c = u;
                        f.c = g[t]
                    }
        ...
        function xc(o, g) {
                    ...
                    if (k && o) {
                        ...
                        if (h && c && a.Db) {
                            if (a.Db & 3 && (!(a.Db & 4) || h > K || c > J)) {
                                var j = l, q = K / J * c / h;
                                if (a.Db & 1)j = q > 1; else if (a.Db & 2)j = q < 1;
                                n = j ? h * J / c : K;
                                m = j ? J : c * K / h
                            }
                            b.q(k, n);
            ...
            function cb(b) {
                if (b == S && s == g) {
                    if (!h) {
                        var a = j;
                        if (A)if (A.sb == g)a = A.Ve(); else A.Ab();
                        Z();
                        h = new vc(o, g, a, r);
                        h.ld(p)
                    }
            ...
            function R(d, e, l) {
                if (d == g) {
                    if (d != e)C[e] && C[e].ve(); else!l && h && h.ue();
                    p && p.ed();
                    var m = S = b.Y();
                    f.Cb(b.S(j, cb, m))
                } else {
            ...
            function T(a, c, d) {
                ...
                b.j(f, function (f) {
                    ...
                    if (i == "player" && !w) {
                        w = f;
                        if (w.pInstance)O(); else b.g(w, "dataavailable", O)
                    }
                    if (i == "caption") {
                        if (c) {
                            b.Oc(f, b.p(f, "to"));
                        ...
                        if (h == "A") {
                            if (b.p(f, "u") == "image")k = b.jf(f, "IMG"); else k = b.E(f, "image", e);
                            if (k) {
                                x = f;
                                b.W(x, "block");
                                b.K(x, V);
        ...
        function vc(y, g, p, q) {
            ...
            a.zc = function () {
                ...
                if (!B && !M && !r && s == g) {
                    ...
                    var l, p = i.Uc;
                    if (b != c)if (b == f)l = c; else if (b == j)l = f; else if (!b)l = j; else l = a.Zc();
                    d.o(p, g, b, n, j, f, c);
                    var m = N && (!E || F);
                    if (b == c)(f != c && !(E & 12) || m) && o.oe(); else(m || b != f) && a.Hc(l, w)
                }
            };
            a.ue = function () {
                f == c && f == a.yb() && a.ab(j)
        ...
        function Bb(d) {
            if (B) {
                ...
                if (f) {
                    ...
                    if ((j || k) && !x) {
                        if (O == 3)if (c.abs(k) > c.abs(j))x = 2; else x = 1; else x = O;
        ...
        d.Ed = function (a) {
            ...
            if (b > u) {
                if (a - s > q / 2)a -= q; else if (a - s <= -q / 2)a += q
            } else a = s + b - d;
            return a
        };
        n.call(d);
        ...
        b.j(uc, function (a) {
            if (a.tagName == "DIV" && !b.p(a, "u"))Q.push(a); else b.tb() && b.L(a, (b.L(a) || 0) + 1)
        });
        ...
        a.uc && b.g(g, "keydown", function (b) {
            if (b.keyCode == 37)ob(-a.uc); else b.keyCode == 39 && ob(a.uc)
        });
        var nb = a.vc;
    ...
    jssor_1_slider_init = function () {
        var g = [{k: 1200, x: .3, B: {f: [.3, .7]}, i: {f: d.l, a: d.m}, a: 2}, {
            k: 1200,
            x: -.3,
            s: e,
            i: {f: d.l, a: d.m},
            a: 2
        }, {k: 1200, x: -.3, B: {f: [.3, .7]}, i: {f: d.l, a: d.m}, a: 2}, {
            k: 1200,
            x: .3,
            s: e,
            i: {f: d.l, a: d.m},
            a: 2
        }, {k: 1200, y: .3, B: {e: [.3, .7]}, i: {e: d.l, a: d.m}, a: 2}, {
            k: 1200,
            y: -.3,
            s: e,
            i: {e: d.l, a: d.m},
            ...
            i: {e: d.l, a: d.m},
            a: 2
        }, {k: 1200, x: .3, n: 2, B: {f: [.3, .7]}, z: {Z: 3}, i: {f: d.l, a: d.m}, a: 2}, {
            k: 1200,
            x: .3,
            n: 2,
            s: e,
            ...
            i: {f: d.l, a: d.m},
            a: 2
        }, {k: 1200, y: .3, C: 2, B: {e: [.3, .7]}, z: {jb: 12}, i: {e: d.l, a: d.m}, a: 2}, {
            k: 1200,
            y: .3,
            C: 2,
            s: e,
            ...
            i: {e: d.l, a: d.m},
            a: 2
        }, {k: 1200, y: .3, n: 2, B: {e: [.3, .7]}, z: {Z: 12}, i: {e: d.l, a: d.m}, a: 2}, {
            k: 1200,
            y: -.3,
            n: 2,
            s: e,
            ...
            i: {e: d.l, a: d.m},
            a: 2
        }, {k: 1200, x: .3, C: 2, B: {f: [.3, .7]}, z: {jb: 3}, i: {f: d.l, a: d.m}, a: 2}, {
            k: 1200,
            x: -.3,
            C: 2,
            s: e,
            ...
            i: {f: d.l, e: d.l, a: d.m},
            a: 2
        }, {k: 1200, P: 20, c: 3, i: {c: d.l, a: d.m}, a: 2}, {
            k: 1200,
            P: 20,
            c: 3,
            s: e,
            i: {c: d.ud, a: d.m},
            a: 2
        }, {k: 1200, P: 20, c: 12, i: {c: d.l, a: d.m}, a: 2}, {
            k: 1200,
            P: 20,
            c: 12,
            s: e,
